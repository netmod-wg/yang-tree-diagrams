...
diagrams in RFCs. For the most current quidelines being developed,
please see the IETF NetMod Working Group Wiki, see:

  https://trac.ietf.org/trac/netmod/wiki/WikiStart
